...
public class Flow {
    ...
    public static void main(String[] args) {
        ...
        Flow flow = new Flow(f);
        ArrayList<FlowVariable> variables = flow.getInitVariables();
        ...
        FlowProblem flowProblem = new FlowProblem(constraints, variables, flow.getSleepTime(), flow.dimension); //TODO: FIX THIS
        GUI gui = new GUI(flowProblem, flow.initFlowVariableGrid);
        flowProblem.run();
    }
}
