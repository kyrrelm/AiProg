...
public class StandardBoards {
    ...
    public static void taskZero(int sleepTime, Astar.SearchType type) {
        ...
        Astar astar = new Astar(new NavigationTaskProblem(10,10,0,0,9,9,barriers),sleepTime);
    ...
    public static void taskOne(int sleepTime, Astar.SearchType type) {
        ...
        Astar astar = new Astar(new NavigationTaskProblem(20,20,0,0,2,18,barriers),sleepTime);
        if (type == Astar.SearchType.ALL){
            doAll(astar);
            return;
        }
    ...
    static void taskTwo(int sleepTime, Astar.SearchType type){
        ...
        Astar astar = new Astar(new NavigationTaskProblem(20,20,0,0,19,19,barriers),sleepTime);
        if (type == Astar.SearchType.ALL){
            doAll(astar);
            return;
        }
    ...
    public static void taskThree(int sleepTime, Astar.SearchType type) {
        ...
        Astar astar = new Astar(new NavigationTaskProblem(10,10,0,0,9,5,barriers),sleepTime);
        if (type == Astar.SearchType.ALL){
            doAll(astar);
            return;
        }
    ...
    static void taskFive(int sleepTime, Astar.SearchType type){
        ...
        Astar astar = new Astar(new NavigationTaskProblem(20,20,0,0,19,13,barriers),sleepTime);
        if (type == Astar.SearchType.ALL){
            doAll(astar);
            return;
        }
