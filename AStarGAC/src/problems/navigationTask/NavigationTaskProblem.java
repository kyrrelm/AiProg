 ...
 */
public class NavigationTaskProblem implements Problem{
    private NavigationState [][] board;
    private NavigationState startState;
    private NavigationState endState;


    public NavigationTaskProblem(int dimX, int dimY, int startX, int startY, int endX, int endY, List<int[]> barriers) {
